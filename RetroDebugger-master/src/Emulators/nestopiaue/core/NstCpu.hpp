...
namespace Nes
{
	namespace Core
	{
		...
		public:
			...
			uint Peek_NoMarking(uint) const;
			void Poke(uint,uint) const;
			void Poke_NoMarking(uint,uint) const;
			...
			// NESd
			volatile unsigned long nesdMainCpuDebugCycle;
			volatile unsigned long nesdMainCpuCycle;
			volatile unsigned long nesdMainCpuPreviousInstructionCycle;
		...
		public:
			...
			struct IoMap : Io::Map<SIZE_64K>
			{
				...
				inline uint Peek8_NoMarking(uint) const;
				inline uint Peek16(uint) const;
				inline void Poke8(uint,uint) const;
				void Poke8_NoMarking(uint,uint) const;
			};
