...
//						Map( 0xC000U, 0xDFFFU, &UxRom::Poke_C000_0 );
//						Map( 0xE000U, 0xFFFFU, &UxRom::Poke_E000_0 );
			...
			{
//				LOGD("POKE %04x %02x", address, data);
				if (!hasbattery)
...
//				NES_PEEK_A(Board,Prg_E) { return prg[3][address - 0xE000]; }
			...
			NES_POKE_AD(UxRom,E000_0)
			{
				prg[3][address - 0xE000] = data;
			}
		}
	}
}
